...
public class SyncStoreProfile
{
	...
	public SyncStoreProfile(Context context)
	{
		...
		this.URL = API_URL + "sync-store-profile.php";
	}
	...
	public void execute()
	{
		...
		StringRequest postRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
			...
			public void onResponse(String response)
			{
				...
				try
				{
					...
					new SQLiteDatabaseHelper(context).updateSyncStatus(TABLE_STORE_PROFILE, KEY_STORE_ID, id, sync_status);
				}
...

		{
			...
			protected Map<String, String> getParams()
			{
				...
				try
				{
					String data = String.valueOf(helper.storeProfileJSONData());
