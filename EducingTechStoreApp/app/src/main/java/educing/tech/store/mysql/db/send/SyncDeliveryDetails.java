...
public class SyncDeliveryDetails
{
	...
	public SyncDeliveryDetails(Context context)
	{
		...
		this.URL = API_URL + "sync-delivery-details.php";
	}
	...
	public void execute()
	{
		...
		StringRequest postRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
			...
			public void onResponse(String response)
			{
				...
				try
				{
					...
					new SQLiteDatabaseHelper(context).updateSyncStatus(TABLE_DELIVERY_DETAILS, KEY_STORE_ID, id, sync_status);
				}
...

		{
			...
			protected Map<String, String> getParams()
			{
				...
				try
				{
					String data = String.valueOf(helper.deliveryDetailsJSONData());
